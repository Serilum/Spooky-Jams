...
public class ModCommon {
	...
	public static void registerAssets(Object modEventBusObject) {
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "glass_jar"),
			() -> new JamItem(new Item.Properties()),
			CreativeModeTabFunctions.getCreativeModeTabResourceKey("ingredients")
		);

		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "creepers_delight_jam"),
			() -> new CreepersDelightJamItem(
				new Item.Properties()
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "endermans_essence_jam"),
			() -> new EndermansEssenceJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "ghasts_whisper_jam"),
			() -> new GhastsWhisperJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "glimmering_gloom_jam"),
			() -> new GlimmeringGloomJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "guardians_brine_jam"),
			() -> new GuardiansBrineJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "phantoms_veil_jam"),
			() -> new PhantomsVeilJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "slimes_squish_jam"),
			() -> new SlimesSquishJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spiders_silk_jam"),
			() -> new SpidersSilkJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spooky_yam_jam"),
			() -> new SpookyYamJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "witchs_hex_jam"),
			() -> new WitchsHexJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "withers_rot_jam"),
			() -> new WithersRotJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "zombies_hunger_jam"),
			() -> new ZombiesHungerJamItem(
				new Item.Properties()
					.component(DataComponents.CUSTOM_NAME,
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spooky_yam_seeds"),
			() -> new SpookyYamSeedsItem(new Item.Properties()),
		...
		Services.REGISTERITEM.registerItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spooky_yam"),
		...
		Services.REGISTERBLOCK.registerBlockWithoutItem(
			modEventBusObject,
			ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spooky_yam_crop"),
			() -> new SpookyYamCropBlock(BlockBehaviour.Properties.of()
	...
	public static void setAssets() {
		// Jar
		SpookyJamsItems.GLASS_JAR = (JamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "glass_jar"));

		// Jams
		SpookyJamsItems.CREEPERS_DELIGHT_JAM = (CreepersDelightJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "creepers_delight_jam"));
		SpookyJamsItems.ENDERMANS_ESSENCE_JAM = (EndermansEssenceJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "endermans_essence_jam"));
		SpookyJamsItems.GHASTS_WHISPER_JAM = (GhastsWhisperJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "ghasts_whisper_jam"));
		SpookyJamsItems.GLIMMERING_GLOOM_JAM = (GlimmeringGloomJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "glimmering_gloom_jam"));
		SpookyJamsItems.GUARDIANS_BRINE_JAM = (GuardiansBrineJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "guardians_brine_jam"));
		SpookyJamsItems.PHANTOMS_VEIL_JAM = (PhantomsVeilJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "phantoms_veil_jam"));
		SpookyJamsItems.SLIMES_SQUISH_JAM = (SlimesSquishJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "slimes_squish_jam"));
		SpookyJamsItems.SPIDERS_SILK_JAM = (SpidersSilkJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spiders_silk_jam"));
		SpookyJamsItems.SPOOKY_YAM_JAM = (SpookyYamJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spooky_yam_jam"));
		SpookyJamsItems.WITCHS_HEX_JAM = (WitchsHexJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "witchs_hex_jam"));
		SpookyJamsItems.WITHERS_ROT_JAM = (WithersRotJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "withers_rot_jam"));
		SpookyJamsItems.ZOMBIES_HUNGER_JAM = (ZombiesHungerJamItem) Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "zombies_hunger_jam"));


		// Seeds
		SpookyJamsItems.SPOOKY_YAM_SEEDS = (SpookyYamSeedsItem)Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spooky_yam_seeds"));

		// Items
		SpookyJamsItems.SPOOKY_YAM = Services.REGISTERITEM.getRegisteredItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spooky_yam"));

		// Blocks
		SpookyJamsBlocks.SPOOKY_YAM_CROP = (SpookyYamCropBlock)Services.REGISTERBLOCK.getRegisteredBlockWithoutItem(ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "spooky_yam_crop"));
	}
